...
<footer class="bg-gray-900 text-white pt-16 pb-8">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
            ...
            <!-- Column 1: About TFL -->
            <div>
                <span class="font-bold text-3xl text-primary block mb-6">TFL LOGO</span>
                <p class="text-gray-400 leading-relaxed mb-6">
                    Training For Life (TFL) is a registered NGO in Tanzania dedicated to transforming youth into empowered leaders by closing the gaps of awareness, access, and marketable skills.
                </p>
            ...
            <div>
                ...
                <ul class="space-y-4 text-gray-400">
                    <li class="flex items-start">
                        ...
                        <span>Dar es Salaam, Tanzania<br>P.O. Box 12345</span>
                    </li>
        ...
        <div class="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-6 md:gap-0">
            <p class="text-gray-500 text-sm text-center md:text-left">
                &copy; {{ date('Y') }} Training For Life. All rights reserved.
            </p>
            
            <!-- Social Media Section -->
            <div class="flex flex-col sm:flex-row items-center space-y-3 sm:space-y-0 sm:space-x-4">
                <span class="text-gray-400 text-sm font-medium tracking-wide uppercase">Our Social Media:</span>
                <div class="flex space-x-4 text-gray-500">
                    <!-- LinkedIn -->
                    <a href="https://www.linkedin.com/in/training-for-life-tfltz-6222063b8" target="_blank" rel="noopener noreferrer" class="hover:text-primary transition" title="LinkedIn">
                        <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/></svg>
                    </a>
                    <!-- Instagram -->
                    <a href="https://www.instagram.com/trainingforlife_tz?igsh=MWNkdDJsd3V6a2RqYQ==" target="_blank" rel="noopener noreferrer" class="hover:text-primary transition" title="Instagram">
                    ...
                    <!-- TikTok -->
                    <a href="https://www.tiktok.com/@training.for.lifetz?_r=1&_t=ZS-98n4qcWsN4j" target="_blank" rel="noopener noreferrer" class="hover:text-primary transition" title="TikTok">
